...
import { ListView, ActivityIndicator, View, Text, Alert } from "react-native";
...
class ReactComp extends Component {
  ...
  renderRow(row, section, ind) {
    ...
    return (
      <View
        style={[this.styles.container, { marginBottom: 5 }]}
  ...
  render() {
    if (
      ...
      // Alert.alert("loading is not");
      // console.log("loading is not going");
      return <ActivityIndicator style={{ marginTop: 80 }} />;
    }
    //Alert.alert("loading is gone");
    return (
      <ListView
        ref={c => (this.list = c)}
        ...
        style={[
          this.props.style,
          {
            backgroundColor: defaultStyle.listViewBackGroundColorCalendar,
            paddingTop: 15,
            paddingBottom: 50
          }
        ]}
